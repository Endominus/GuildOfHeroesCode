...
def load_level(level_name, gs):
	if level_name == "prologue_outside":
		...
		level.add_events_dict(['prologue_near_stealther', 'prologue_near_mad_dog'], [False, False])
		...
		level.add_dialog_node("0.0.0", True, [[[0, 100], [0, 100], [0, 100], [0, 80], [30, 100]], [], "He doesn't look like a tourist...", [-1, -1, -1, 40, 60], ["Really? Because you look more like a supervillain.", "Shay de Morta", 0, 0, [], -5, -20, False]])
		level.add_dialog_node("0.0.0.0", False, ["Uh...", "Possible Supervillain", 0, 0, [], 0, 0, False])
		level.add_dialog_node("0.0.0.0.0", False, ["Oh, I get it. You're a cosplayer, aren't you? I read about you guys on the Internet. You go around dressed like your favorite bad guy, right?", "Shay de Morta", 0, 0, [], 0, 0, False])
		level.add_dialog_node("0.0.0.0.0.0", False, ["That's right! I came here dressed as the dreaded villain, Anghamar. But I'm not him. Just acting.", "Just a cosplayer", 0, 0, [], 0, 0, False])
		level.add_dialog_node("0.0.0.0.0.0.0", False, ["Huh, I've never heard of Anghamar. He must be pretty small-time. Well, I 'll leave you to it, then.", "Shay de Morta", 0, 0, [], -10, -30, True])
		
		level.add_dialog_node("0.0.1", True, [[[30, 100], [0, 100], [0, 100], [50, 100], [0, 100]], [], "Cool, another superhero nerd!", [60, -1, 55, 70, -1], ["You're a tourist? I just got here myself, though I wanted to come for years. Isn't this place awesome? Have you seen all the trophies they have?", "Shay de Morta", 0, 0, [], -5, -10, False]])
		level.add_dialog_node("0.0.1.0", False, ["Yes. I've seen the... trophies. They are very nice testaments to the Guild's... effectiveness in battle.", "Not Suspicious At All", 0, 0, [], 0, 0, False])
		
		level.add_dialog_node("0.0.1.0.0", True, [[[30, 100], [40, 100], [40, 100], [0, 100], [0, 100]], [], "Not just in battle!", [-1, 60, 70, -1, -1], ["Hey, the Guild of Heroes is more than a group of people punching out bad guys, you know. They have a really active charitable arm and stuff. You should read this book I've got here by Paragon, \'The Vanguard of Righteousness.\' It talks about how great the Guild is for the country and stuff.", "Shay de Morta", 0, 0, [], -20, -30, False]])
		level.add_dialog_node("0.0.1.0.0.0", False, ["Trust me, I've read the book. I did not come away from it as... enchanted as you clearly were. Now if you would excuse me, I really must get back to observing the area.", "Clearly In It For the Punches", 0, 0, [], 0, 0, False])
		level.add_dialog_node("0.0.1.0.0.0.0", False, ["Whatever, dude. Suit yourself.", "Shay de Morta", 0, 0, [], 0, 0, True])
		
		level.add_dialog_node("0.0.1.0.1", True, [[[0, 100], [0, 100], [0, 100], [0, 100], [0, 100]], [], "That sounded kinda suspicious.", [-1, -1, -1, -1, -1], ["Do you have some kinda problem with the Guild? Like those people outside?", "Shay de Morta", 0, 0, [], 5, -20, False]])
		level.add_dialog_node("0.0.1.0.1.0", False, ["No, not like those people. They want to join the Guild. I... do not. Please, go. I have wasted enough time speaking to you.", "Definitely A Creep", 0, 0, [], 0, 0, True])
